...
MVP-status on merkitty jokaisen käyttötapauksen otsikkoon. Tiketti #6 määrittelee täydellisen MVP-linjauksen.

### 1. Kofeiini-ikkunan optimointi *(MVP — tiketti #5)*
...
### 2. Alkoholi ensimmäisen unijakson käynnistäjänä *(MVP — tiketti #6)*
...
### 3. Lauantai–sunnuntai-sykli *(MVP — tiketti #6)*
...
### 4. Päiväuni ehdollisena korjausliikkeenä *(post-MVP — nap-tunnistus stub MVP:ssä, täysi logiikka tiketti #32:ssa)*
...
### 5. Yhden työjakson malli *(post-MVP — tiketti #32)*
