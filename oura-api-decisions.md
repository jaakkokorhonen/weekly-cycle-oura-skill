...
|---|---|---|
| `type` | string | `long_sleep` / `short_sleep` / `rest` — erottaa yöunen napista |
...
| `bedtime_start` | ISO 8601 | UTC-muunnos eksplisiittisesti `pipeline.py`:ssä |
| `bedtime_end` | ISO 8601 | |

**Biphasic-tunnistus:** `sleep_phase_5_min`-sarjassa > 30–60 min `Awake`-jakso kahden univaihejakson välissä → `sleep_mode: biphasic`.
...
**MVP-ratkaisu:** `oura_readiness_score` tallennetaan, mutta ei ohjaa rule engineä suoraan — vain verrokkidata.
...
Univaiheita ei universaalisti saatavilla lyhyille napeille.
...
Data valmistuu tyypillisesti aamulla (ei realtimea). Cron-ajo tai manuaalinen trigger riittää MVP:ssä.
...
| Tiketti | Aihe | Tila |
|---|---|---|
| [#14](https://github.com/jaakkokorhonen/weekly-cycle-oura-skill/issues/14) | Sleep-kentät | ✅ Suljettu 2026-07-19 |
| [#15](https://github.com/jaakkokorhonen/weekly-cycle-oura-skill/issues/15) | HRV | ✅ Suljettu 2026-07-19 |
| [#16](https://github.com/jaakkokorhonen/weekly-cycle-oura-skill/issues/16) | Readiness | ✅ Suljettu 2026-07-19 |
| [#17](https://github.com/jaakkokorhonen/weekly-cycle-oura-skill/issues/17) | Aktiivisuus | ✅ Suljettu 2026-07-19 |
| [#18](https://github.com/jaakkokorhonen/weekly-cycle-oura-skill/issues/18) | Tagit | ⏳ Post-MVP |
| [#19](https://github.com/jaakkokorhonen/weekly-cycle-oura-skill/issues/19) | Päiväunet | ✅ Suljettu 2026-07-19 |
| [#20](https://github.com/jaakkokorhonen/weekly-cycle-oura-skill/issues/20) | Historiadatan haku | ✅ Suljettu 2026-07-19 |
| [#21](https://github.com/jaakkokorhonen/weekly-cycle-oura-skill/issues/21) | Leposyke | ✅ Suljettu 2026-07-19 |
| [#23](https://github.com/jaakkokorhonen/weekly-cycle-oura-skill/issues/23) | Lämpötilapoikkeama | ⏳ Post-MVP |
